function [Eclairement_calibre, pos_soleil,hauteur_soleil,azimut_soleil]=calibration_E(Eeg, Eed, minutes, jour,coord, decalage_heure)
...
Eclairement_calibre=[];
    for i=1:1:length(Eed)
        ...
        cosphi=Calcul_eclairement(A, B, C, position_soleil);
        if cosphi<=0
            Eclairement_calibre(i)=0;
        else
