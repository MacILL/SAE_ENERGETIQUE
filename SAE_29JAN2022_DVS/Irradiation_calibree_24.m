function [IrrSUD24h, IrrEST24h,IrrNORD24h, IrrOUEST24h]=Irradiation_calibree_24(matObstacle, TScene,SScene,TBat,SBat2,chem)
...
IrrSUD=zeros(1,23); nb_facadeSUD=0;
IrrEST=zeros(1,23); nb_facadeEST=0;
IrrNORD=zeros(1,23); nb_facadeNORD=0;
IrrOUEST=zeros(1,23); nb_facadeOUEST=0;
...
for ind_triangle=1:1:size(TScene,1)
    ...
    [Irr_moy]=irradiation(minutes_conforme, indices_heure, matObstacle,Eclairement_calibre,Eed_conforme, pos_soleil, TScene,SScene,ind_triangle,0,TBat,SBat2); 
