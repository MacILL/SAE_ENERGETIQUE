...
[Triangles_batiment,Sommets_batiment,Type] = tesselle_type(TriBat,S,aire_min_bat);
TBatType=[Triangles_batiment, Type];
%Aff_verification2(Sommets_batiment, Triangles_batiment)